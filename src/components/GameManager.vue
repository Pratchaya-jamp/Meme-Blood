...
<template>
  ...
  <button
    v-if="showPlayerInventory"
    @click="closePlayerInventory"
    class="cursor-pointer bg-gradient-to-r from-red-600 to-red-400 font-bold text-white text-lg px-6 py-3 border-2 border-gray-800 rounded-xl shadow-lg hover:scale-105 active:scale-95 transition-all duration-200"
  >
    Close Inventory
  </button>
</template>
